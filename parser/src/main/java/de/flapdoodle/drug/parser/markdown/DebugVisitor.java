...
public class DebugVisitor implements Visitor {
	...
	public void visit(ExpLinkNode node) {
		...
		printer.print("[explink: " + node + "|" + text + "]");
	}
	...
	public void visit(RefLinkNode node) {
		...
		if (refNode == null) { // "fake" reference link
			...
			printer.print("[link: " + node + ",url=" + refNode.getUrl() + ",title=" + refNode.getTitle() + ",text=" + text
					+ "]");
		}
	}
